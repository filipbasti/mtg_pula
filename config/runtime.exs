...
#
#     PHX_SERVER=true bin/mtg_pula start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :mtg_pula, MtgPulaWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :mtg_pula, MtgPulaWeb.Endpoint,
    ...
    https: [
      ...
      cipher_suite: :strong,
      certfile: "/etc/letsencrypt/live/mtgpula.site/fullchain.pem",  # Path to SSL cert
      keyfile: "/etc/letsencrypt/live/mtgpula.site/privkey.pem"      # Path to SSL key
    ],
    force_ssl: [hsts: true],
    check_origin: [
    "http://localhost:5173",
